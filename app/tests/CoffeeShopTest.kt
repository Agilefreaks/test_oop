...
class CoffeeShopTest {
    ...
    fun `test coffee shop`() {
        ...
        assertEquals(Location(21.51, -74.58), shop.location)
    }
    ...
    fun `test coffee shop from csv row`() {
        ...
        assertEquals(Location(-33.871843, 151.206767), shop.location)
    }
    ...
    fun `test coffee shops from csv rows`() {
        ...
        assertEquals(Location(-22.923489, -43.234418), shops[0].location)
        assertEquals("Starbucks Sydney", shops[1].name)
        assertEquals(Location(-33.871843, 151.206767), shops[1].location)
    }
